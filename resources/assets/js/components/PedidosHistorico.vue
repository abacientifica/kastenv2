            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Hisotirico Facturación
                    </div>
                    <!--Listado de ingreso-->
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="documento_busqueda">
                                      <option value="61">Pedidos</option>
