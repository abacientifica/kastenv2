            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Solicitud Devolución <label v-if="IdDocSeleccionado>0" v-text="'/ '+NombreDoc"></label>
                    </div>
                    ...
                    <template v-if="listado ==4">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button type="button" @click="ocultarDetalle()" class="btn btn-secondary">Cerrar</button>
                                    <button type="button" class="btn btn-primary" @click="RegistrarMovimiento()">Registrar Pedido</button>
                                </div>
                            </div>
                        </div>
                    </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ListarDocumentos(){
                let me = this;
                var url = '/documentos/ObtenerDocTp/?Tp='+16;
                axios.get(url).then(function (response) {
                    var respuesta = response.data;
